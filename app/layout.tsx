...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_IN',
    images: [{ url: `${siteConfig.brand.domain}/opengraph-image`, width: 1200, height: 630 }],
  },
  twitter: { card: 'summary_large_image', images: [`${siteConfig.brand.domain}/opengraph-image`] },
  verification: {
...
const localBusinessSchema = {
  ...
  image: `${siteConfig.brand.domain}/opengraph-image`,
  telephone: siteConfig.contact.phone,
  email: siteConfig.contact.email,
  address: { '@type': 'PostalAddress', addressLocality: 'Noida', addressRegion: 'Uttar Pradesh', addressCountry: 'IN' },
  url: siteConfig.brand.domain,
